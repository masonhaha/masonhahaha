...
Using an ESP32-CAM to unlock a door when a face is recognised.  A simple access control system based on face recognition with the ESP32-CAM and the Arduino IDE.It can store facial features in FLASH and save face recognition logs to an SD card.
